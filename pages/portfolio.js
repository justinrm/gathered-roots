      ...
      <main id="main-content" className="bg-background min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-background p-8 rounded-lg shadow-md">
          ...
          <p className="text-text-light mb-8">
            Explore our before and after gallery to see the difference Gathered Roots Cleaning
            brings to every home. We take pride in our work and love helping our clients rediscover
            the beauty of their spaces.
          </p>
          <PortfolioCarousel />
        </div>
      </main>
