        ...
        <div className="max-w-3xl mx-auto bg-background p-8 rounded-lg shadow-md">
          ...
          <section className="mb-6">
            ...
            <p className="text-text-dark mb-4">
              We believe that everyone should have equal access to information about our cleaning services. 
              Our website is designed and developed following the{' '}
              <a 
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-text-dark space-y-2">
              <li>
                ...
                only a keyboard, with clear focus indicators showing which element is currently selected.
              </li>
              <li>
              ...
              <li>
                <strong>Color Contrast:</strong> All text meets or exceeds WCAG 2.1 AA color contrast 
                requirements (4.5:1 for normal text, 3:1 for large text) to ensure readability.
              </li>
              <li>
                <strong>Responsive Design:</strong> Our mobile-first design ensures the website works 
                effectively across all devices and screen sizes.
              </li>
              <li>
              ...
              <li>
                <strong>Focus Management:</strong> Interactive elements have visible focus indicators 
                and focus is managed appropriately throughout the user journey.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-text-dark space-y-1">
              ...
              <li><strong>Mobile Devices:</strong> Smartphones and tablets with touch and voice interfaces</li>
            </ul>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-text-dark">
              Accessibility is an ongoing effort. We regularly review and test our website to identify 
              and address accessibility barriers. Our development team stays current with accessibility 
              best practices and emerging standards to ensure our website continues to meet the needs 
              of all users.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-text-dark">
              ...
              platforms or maps). While we work to ensure these services meet accessibility standards, 
              we cannot guarantee their accessibility. If you experience difficulties with third-party 
              content, please contact us for alternative access methods.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-text-dark space-y-1">
              ...
              <li>JavaScript for enhanced functionality (website remains functional without JavaScript)</li>
